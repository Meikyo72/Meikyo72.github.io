...
/* start of input variables */
  ...
  // ...
        ...
        function addMessToTable(data) {
				...
				tr.innerHTML = `<td>${data.internalID}</td> <td>${data.idNr}</td> <td>${data.adress}</td> <td>${data.city}</td> <td id="${data.objectKey}" onclick="console.log('Klicked')">${data.objectKey}</td>`;
